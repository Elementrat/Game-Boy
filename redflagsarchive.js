...
(function (RedFlagState) {
    RedFlagState[RedFlagState["PreGame"] = 0] = "PreGame";
    RedFlagState[RedFlagState["AcceptingPerks"] = 1] = "AcceptingPerks";
    RedFlagState[RedFlagState["RevealingPerks"] = 2] = "RevealingPerks";
    RedFlagState[RedFlagState["AcceptingRedFlags"] = 3] = "AcceptingRedFlags";
    RedFlagState[RedFlagState["RevealingRedFlags"] = 4] = "RevealingRedFlags";
    RedFlagState[RedFlagState["WaitingForDecision"] = 5] = "WaitingForDecision";
    RedFlagState[RedFlagState["PostRound"] = 6] = "PostRound";
})(RedFlagState = exports.RedFlagState || (exports.RedFlagState = {}));
var RedFlagResponseCode;
(function (RedFlagResponseCode) {
    RedFlagResponseCode[RedFlagResponseCode["ERR_ALREADY_HANDED_IN"] = 0] = "ERR_ALREADY_HANDED_IN";
    RedFlagResponseCode[RedFlagResponseCode["ERR_INDEX_OUT_OF_BOUNDS"] = 1] = "ERR_INDEX_OUT_OF_BOUNDS";
    RedFlagResponseCode[RedFlagResponseCode["ERR_SAME_PICKS"] = 2] = "ERR_SAME_PICKS";
    RedFlagResponseCode[RedFlagResponseCode["ERR_NAN"] = 3] = "ERR_NAN";
    RedFlagResponseCode[RedFlagResponseCode["SUCCESS"] = 4] = "SUCCESS";
})(RedFlagResponseCode = exports.RedFlagResponseCode || (exports.RedFlagResponseCode = {}));
var RedFlagsTemplate = (function (_super) {
    __extends(RedFlagsTemplate, _super);
    //4 perks, 3 red flags
    function RedFlagsTemplate() {
        var _this = _super.call(this) || this;
        _this.perkHandSize = 4;
        _this.redFlagHandSize = 3;
        _this.requiresExplicitJoin = true;
        _this.requiresVoice = true;
        _this.name = "Red-Flags";
        _this.rules = "\n**The Dates** \n";
        _this.rules += "When a round starts, you will receive *Perks* and *Red Flags.* \n";
        _this.rules += "- Choose *Perks* to create an ideal date for the *The Single* \n";
        _this.rules += "- Then, use a *Red Flag* to ruin someone else's chances. \n";
        _this.rules += "- Finally, convince *The Single* to choose your date. \n";
        _this.rules += "\n**The Single** \n";
        _this.rules += " On round start, The Singles will choose their perks to try to win you over. \n";
        _this.rules += " - When everyone's submitted, you get to choose your favorite.";
        _this.roles = [
        ...
        _this.description = "Try to ruin each others' dates";
        _this.perks = [
    ...
    RedFlagsTemplate.prototype.create = function (channel) {
        var inst = new RedFlagsInstance(this);
        inst.channel = channel;
        return inst;
    };
    return RedFlagsTemplate;
}(games_1.GameTemplate));
exports.RedFlagsTemplate = RedFlagsTemplate;
var RedFlagsInstance = (function (_super) {
    __extends(RedFlagsInstance, _super);
    function RedFlagsInstance(template) {
        var _this = _super.call(this, template) || this;
        _this.gameState = RedFlagState.PreGame;
        return _this;
    }
    RedFlagsInstance.prototype.initialSetup = function () {
    ...
    RedFlagsInstance.prototype.transitionGameState = function (newState) {
        this.gameState = newState;
    };
    //returns true if complete, false if not
    RedFlagsInstance.prototype.checkPerksComplete = function () {
        var me = this;
        var complete = true;
        ...
        console.log("About to return: " + complete);
        return complete;
    };
    //returns true if complete, false if not
    RedFlagsInstance.prototype.checkRedFlagsComplete = function () {
        var me = this;
        var complete = true;
        this.theDates.forEach(function (date) {
    ...
    RedFlagsInstance.prototype.acceptPerks = function (author, indexOne, indexTwo) {
    ...
    //flag is applied to the date
    RedFlagsInstance.prototype.acceptFlag = function (author, theDate, index) {
        if (isNaN(index))
            return RedFlagResponseCode.ERR_NAN;
    ...
    RedFlagsInstance.prototype.drawPerks = function (num) {
        var hand = new Array();
        for (var x = 0; x < num; x++) {
    ...
    RedFlagsInstance.prototype.getDateEmbed = function (user, showFlags) {
    ...
    RedFlagsInstance.prototype.drawFlags = function (num) {
        var flags = new Array();
        for (var x = 0; x < num; x++) {
    ...
    RedFlagsInstance.prototype.grantPoints = function (user, num) {
    ...
    RedFlagsInstance.prototype.getScoreBoardEmbed = function () {
    ...
    RedFlagsInstance.prototype.onPublicMessage = function (inputSequence, message, channel, author) {
    ...
    RedFlagsInstance.prototype.onDM = function (message, DMChannel, author) {
    ...
    RedFlagsInstance.prototype.round = function () {
        var str = "";
        this.currentRound++;
    ...
    return RedFlagsInstance;
}(games_1.GameInstance));
exports.RedFlagsInstance = RedFlagsInstance;
